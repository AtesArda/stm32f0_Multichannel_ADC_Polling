...
void  Read_ADC()
{
	  ...
	  HAL_ADC_Start(&hadc);
	  HAL_ADC_PollForConversion(&hadc,1000);
	  readValue2 = HAL_ADC_GetValue(&hadc);
	  HAL_ADC_Stop(&hadc);

	  //sConfigPrivate.Channel = ADC_CHANNEL_TEMPSENSOR;
	  //HAL_ADC_ConfigChannel(&hadc, &sConfigPrivate);
//	  HAL_ADC_Start(&hadc);
//	  HAL_ADC_PollForConversion(&hadc,1000);
//	  readValue3 = HAL_ADC_GetValue(&hadc);
//	  HAL_ADC_Stop(&hadc);
